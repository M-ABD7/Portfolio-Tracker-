...
export default function AISuggestionsPage() {
  ...
  const hasInsights = (insights?.recommendations.length ?? 0) > 0;
  ...
  return (
    <div className="space-y-8">
      ...
      {insights && !loading && !error && hasInsights && (
        <>
      ...
      {insights && !loading && !error && !hasInsights && (
        <Card>
          <CardContent className="py-8 text-center space-y-4">
            <div>
              <p className="text-lg font-semibold text-foreground">No signals yet</p>
              <p className="text-foreground-muted mt-2">
                Add assets or connect a wallet first. Signals, diversification tips, and weight allocation appear after your portfolio has holdings.
              </p>
            </div>
